---
title: Golang Kafka Email Notification System
description: fetching data from websites that use pagination for their data using Golang, and providing tags to determine which pages to fetch, as well as downloading images.
repository: SyaibanAhmadRamadhan/go-pub-sub-kafka
tech: [Golang, Kafka, SMTP, Docker]
date: 2024-06-04
published: true
