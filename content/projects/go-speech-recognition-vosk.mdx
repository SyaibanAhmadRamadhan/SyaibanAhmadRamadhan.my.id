---
title: Golang Speech Recognition with Vosk and PortAudio
description: This project demonstrates how to implement real-time speech-to-text transcription in Golang using the Vosk speech recognition toolkit and the PortAudio library for capturing audio input. Vosk is an open-source speech recognition toolkit that provides excellent accuracy for various languages and works offline, making it a powerful tool for real-time transcription applications.
repository: SyaibanAhmadRamadhan/go-speech-recognition-vosk
tech: [Golang, Vosk, PortAudio]
date: 2024-06-06
published: true
